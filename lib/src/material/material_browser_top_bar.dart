...
class MaterialBrowserTopBar extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _MaterialBrowserTopBarState();
  }
}

class _MaterialBrowserTopBarState extends State<MaterialBrowserTopBar> {
  @override
    ...
    return DecoratedBox(
      ...
      child: Row(
        ...
        children: [
          ...
          const Expanded(
            child: MaterialBrowserAddressField(),
          ),
